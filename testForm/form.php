<form  data-ppFormTag="mailer" action="/" method="post">
    ...
    <div id="mail-form">
        <label>主題:</label><input data-ppForm type="text" name="subject" data-required >
        <br>
    ...
    <div id="address-form">
        ...
        <label>都道府県:</label>
        <select data-ppForm name="prefecture" data-required>
            <?php include "prefecture-form.php"; ?>
        </select>
        <br>
        <div class="em" data-error="prefecture" ></div>
        <label>市区町村:</label><input data-ppForm type="text" name="city" data-required>
        <br>
        <div class="em" data-error="city" ></div>
        <label>丁目番地:</label><input data-ppForm type="text" name="address" data-required>
        <br>
        <div class="em" data-error="address" ></div>
        <label>マンション・アパート名:</label><input data-ppForm type="text" name="house" data-required>
        <br>
